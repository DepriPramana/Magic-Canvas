...
const GenerativeFillToolbar: React.FC<GenerativeFillToolbarProps> = ({
  position,
  prompt,
  onPromptChange,
  onGenerate,
  ...
  return (
    <div
      className="absolute bg-white/90 backdrop-blur-sm shadow-2xl rounded-xl p-2 flex items-center gap-2 z-30 border border-gray-200"
...
export default GenerativeFillToolbar;
