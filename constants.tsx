...
export const ICONS: { [key: string]: JSX.Element } = {
  ...
  remove_bg: (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
        <path d="M9.5 2.5l1.5 1.5-6 6L3.5 8.5l6-6z"/>
        <path d="M19.5 13.5l-6 6-1.5-1.5 6-6 1.5 1.5z"/>
        <path d="M15 8l-3 3"/>
        <path d="M2.5 13.5l6-6"/>
        <path d="M13.5 2.5l6 6"/>
    </svg>
  ),
  trash: (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
  ...
  ungroup: (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
        <path d="M21 5a2 2 0 0 0-2-2H9l-2 3H4a2 2 0 0 0-2 2v10a2 2 0 0 0 2 2h15a2 2 0 0 0 2-2z"></path>
        <line x1="10" y1="14" x2="14" y2="10"></line>
